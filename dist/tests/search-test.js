            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    resultPage.clickAndGetResult().then(function (btnsAndTexts) {
                        ...
                        var failedRows = result.filter(function (item, index) {
                            item["failedInfo"] = {
                        ...
                        if (failedRows) {
                            retest_1.retest(keyword, failedRows).then(function (res) {
                                if (res) {
                                    var _loop_1 = function (i) {
                                        var rerunRes = res[i + 1].every(function (r) {
                                            return r.toLowerCase().includes(res[i].keyword.toLowerCase());
                                        })
                                            ? "PASS"
                                            : "FAIL";
